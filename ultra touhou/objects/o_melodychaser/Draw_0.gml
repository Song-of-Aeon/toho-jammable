...
depth = -3;
draw_text_transformed_colour(blueposaved, bar+230, string(combo), floor(combo/100)/10+.5, floor(combo/100)/10+.5, 0, combocolour[0], combocolour[1], combocolour[2], combocolour[3], infoalpha);
