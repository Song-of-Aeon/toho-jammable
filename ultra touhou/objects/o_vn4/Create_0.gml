...
new Page("How did you like them? The games you can play by pretending to be a human.", wordspeed, function(){sum.image_index = sumEmotion.Happy; o_vn4.talking = 0}),
new Page("Nothing special, nothing bad. Humans are talented at making trinkets.", wordspeed, function(){mam.image_index = mamEmotion.Smug; o_vn4.talking = 1}),
new Page("I much prefer the game you choose to play while pretending to be a youkai.", wordspeed, function(){o_vn4.talking = 1}),
new Page("Of course. Imitation magic in pixels can't match the real thing.", wordspeed, function(){sum.image_index = sumEmotion.Smug2; o_vn4.talking = 0}),
