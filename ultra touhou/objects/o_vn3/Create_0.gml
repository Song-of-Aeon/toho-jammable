...
new Page("I wonder how much of that is just because of your biology, though.", wordspeed, function(){ o_vn3.talking = 0}),
...
new Page("Just so you know, I won't accept anything from a tanuki anymore, even if I win.", wordspeed, function(){sum.image_index = sumEmotion.Disappointed; o_vn3.talking = 0}),
new Page("Ah, what a frightened human. A sight for sore eyes.", wordspeed, function(){mam.image_index = mamEmotion.Smug2; o_vn3.talking = 1}),
...
new Page("Meaningless games are fine by me. Nothing you could give me that I couldn't get myself, anyway.", wordspeed, function(){mam.image_index = mamEmotion.Smug; o_vn3.talking = 1}),
...
new Page("Now that I've flown, they kind of seem useless, though. Cars, that is.", wordspeed, function(){sum.image_index = sumEmotion.Smug2; o_vn3.talking = 0}),
...
new Page("What is that supposed to be about, Icarus? I know my limits.", wordspeed, function(){sum.image_index = sumEmotion.Confused; o_vn3.talking = 0}),
